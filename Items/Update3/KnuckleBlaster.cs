...
namespace Planetside
{
    public class KnuckleBlaster : LabelablePlayerItem
    {
        ...
        public static void Init()
        {
            ...
            KnuckleBlaster lockpicker = obj.AddComponent<KnuckleBlaster>();
            ...
            lockpicker.SetupUnlockOnCustomFlag(CustomDungeonFlags.HAS_COMPLETED_SOMETHING_WICKED, true);

            KnuckleBlaster.ItemspriteIDs = new int[KnuckleBlaster.itemspritepaths.Length];
            KnuckleBlaster.ItemspriteIDs[0] = SpriteBuilder.AddSpriteToCollection(KnuckleBlaster.itemspritepaths[0], lockpicker.sprite.Collection);
            KnuckleBlaster.ItemspriteIDs[1] = SpriteBuilder.AddSpriteToCollection(KnuckleBlaster.itemspritepaths[1], lockpicker.sprite.Collection);
            KnuckleBlaster.ItemspriteIDs[2] = SpriteBuilder.AddSpriteToCollection(KnuckleBlaster.itemspritepaths[2], lockpicker.sprite.Collection);
