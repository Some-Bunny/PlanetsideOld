...
namespace Planetside
{
    public class HeresyHammer : PlayerItem
    {
        public static void Init()
        {
            ...
            HeresyHammer testActive = obj.AddComponent<HeresyHammer>();
            ...
            testActive.SetupUnlockOnCustomFlag(CustomDungeonFlags.DECURSE_HELL_SHRINE_UNLOCK, true);
            ItemBuilder.AddPassiveStatModifier(testActive, PlayerStats.StatType.Curse, 0.5f, StatModifier.ModifyMethod.ADDITIVE);
            ...
            ItemBuilder.AddPassiveStatModifier(testActive, PlayerStats.StatType.RateOfFire, 1.20f, StatModifier.ModifyMethod.MULTIPLICATIVE);
        ...
        private IEnumerator DoNormalBoringAssReward(Vector2 Center)
        {
            ...
            {
                LootEngine.SpawnCurrency(Center, UnityEngine.Random.Range(6, 24));
            }
            ...
            {
                GameManager.Instance.RewardManager.SpawnTotallyRandomItem(Center, ItemQuality.D, ItemQuality.B);
            }
            yield break;
        }
