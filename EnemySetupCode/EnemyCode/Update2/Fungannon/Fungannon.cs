	...
	class Fungannon : AIActor
	{
		...
		public static void BuildPrefab()
		{
			...
			if (!flag2)
			{
				...
				enemy.aiActor.healthHaver.ForceSetCurrentHealth(1025f);
					...
					AnimNames = new string[]
	{
		...
		public class EnemyBehavior : BraveBehaviour
		{
			...
			public void Start()
			{
				...
				{
					for (int i = 0; i < Fungannon.m_reticles.Count; i++)
					{
						SpawnManager.Despawn(Fungannon.m_reticles[i]);
						Destroy(Fungannon.m_reticles[i]);
					}
