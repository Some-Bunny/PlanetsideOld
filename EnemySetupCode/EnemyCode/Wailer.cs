		...
		public static void BuildPrefab()
		{
			...
			bs.MovementBehaviors = new List<MovementBehaviorBase>
			{
				...
				*/
				...
				companion.encounterTrackable.journalData.enemyPortraitSprite = ItemAPI.ResourceExtractor.GetTextureFromResource("Planetside\\Resources\\Ammocom\\wailericonammo.png");
				...
				PlanetsideModule.Strings.Enemies.Set("#THE_WAILER_LONGDESC", "A writhing, agonized mess of a bullet kin that managed to escape the pits of Bullet Hell. The pain it feels so so unbearable it manifists physically as bullets.");
