...
namespace Planetside
{
	public class RetrashBullet : AIActor
	{
		...
		public static readonly string guid = "retrash_bullet";
		private static tk2dSpriteCollectionData RetrashBullete;
		public static GameObject shootpoint;
		public static void Init()
		{
			RetrashBullet.BuildPrefab();
		}
		...
		public static void BuildPrefab()
		{
			...
			if (!flag2)
			{
				...
				prefab = EnemyBuilder.BuildPrefab("Retrash Bullet", guid, spritePaths[0], new IntVector2(0, 0), new IntVector2(8, 9), false);
				...
				bool flag3 = RetrashBullete == null;
				if (flag3)
				{
					RetrashBullete = SpriteBuilder.ConstructCollection(prefab, "HunterBullet_Collection");
					UnityEngine.Object.DontDestroyOnLoad(RetrashBullete);
					for (int i = 0; i < spritePaths.Length; i++)
					{
						SpriteBuilder.AddSpriteToCollection(spritePaths[i], RetrashBullete);
					}
					SpriteBuilder.AddAnimation(companion.spriteAnimator, RetrashBullete, new List<int>
					{
		...
		private static string[] spritePaths = new string[]
		{
			...
			"Planetside/Resources/Enemies/ModderBullets/retrash/retrashbullet_idle_001.png",
			"Planetside/Resources/Enemies/ModderBullets/retrash/retrashbullet_idle_002.png",
			"Planetside/Resources/Enemies/ModderBullets/retrash/retrashbullet_idle_003.png",
			"Planetside/Resources/Enemies/ModderBullets/retrash/retrashbullet_idle_004.png",

			//death
			"Planetside/Resources/Enemies/ModderBullets/retrash/retrashbullet_die_001.png",
			"Planetside/Resources/Enemies/ModderBullets/retrash/retrashbullet_die_002.png",
			"Planetside/Resources/Enemies/ModderBullets/retrash/retrashbullet_die_003.png",
			"Planetside/Resources/Enemies/ModderBullets/retrash/retrashbullet_die_004.png",
			"Planetside/Resources/Enemies/ModderBullets/retrash/retrashbullet_die_005.png",
		};
