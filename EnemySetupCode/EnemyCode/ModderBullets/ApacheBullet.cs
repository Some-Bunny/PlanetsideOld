...
namespace Planetside
{
	public class ApacheBullet : AIActor
	{
		...
		public static readonly string guid = "apache_bullet";
		private static tk2dSpriteCollectionData ApacheBulleet;
		public static GameObject shootpoint;
		public static void Init()
		{
			ApacheBullet.BuildPrefab();
		}
		...
		public static void BuildPrefab()
		{
			...
			if (!flag2)
			{
				...
				bool flag3 = ApacheBulleet == null;
				if (flag3)
				{
					ApacheBulleet = SpriteBuilder.ConstructCollection(prefab, "An3sBullet_Collection");
					UnityEngine.Object.DontDestroyOnLoad(ApacheBulleet);
					for (int i = 0; i < spritePaths.Length; i++)
					{
						SpriteBuilder.AddSpriteToCollection(spritePaths[i], ApacheBulleet);
					}
					SpriteBuilder.AddAnimation(companion.spriteAnimator, ApacheBulleet, new List<int>
					{
		...
		private static string[] spritePaths = new string[]
		{
			...
			"Planetside/Resources/Enemies/ModderBullets/apache/apachebullet_idle_001.png",
			"Planetside/Resources/Enemies/ModderBullets/apache/apachebullet_idle_002.png",
			"Planetside/Resources/Enemies/ModderBullets/apache/apachebullet_idle_003.png",
			"Planetside/Resources/Enemies/ModderBullets/apache/apachebullet_idle_004.png",


			//death
			"Planetside/Resources/Enemies/ModderBullets/apache/apachebullet_die_001.png",
			"Planetside/Resources/Enemies/ModderBullets/apache/apachebullet_die_002.png",
			"Planetside/Resources/Enemies/ModderBullets/apache/apachebullet_die_003.png",
			"Planetside/Resources/Enemies/ModderBullets/apache/apachebullet_die_004.png",
