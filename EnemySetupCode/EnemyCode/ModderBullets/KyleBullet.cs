...
namespace Planetside
{
	public class KyleBullet : AIActor
	{
		...
		public static readonly string guid = "kyle_bullet";
		private static tk2dSpriteCollectionData KyleBulleet;
		public static GameObject shootpoint;
		public static void Init()
		{
			KyleBullet.BuildPrefab();
		}
		...
		public static void BuildPrefab()
		{
			...
			if (!flag2)
			{
				...
				prefab = EnemyBuilder.BuildPrefab("Kyle Bullet", guid, spritePaths[0], new IntVector2(0, 0), new IntVector2(8, 9), false);
				...
				bool flag3 = KyleBulleet == null;
				if (flag3)
				{
					KyleBulleet = SpriteBuilder.ConstructCollection(prefab, "An3sBullet_Collection");
					UnityEngine.Object.DontDestroyOnLoad(KyleBulleet);
					for (int i = 0; i < spritePaths.Length; i++)
					{
						SpriteBuilder.AddSpriteToCollection(spritePaths[i], KyleBulleet);
					}
					SpriteBuilder.AddAnimation(companion.spriteAnimator, KyleBulleet, new List<int>
					{
