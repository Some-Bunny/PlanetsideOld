	...
	public class BleakBullet : AIActor
	{
		...
		public static void BuildPrefab()
		{
			...
			if (!flag2)
			{
				...
				prefab = EnemyBuilder.BuildPrefab("Bleak Bullet", guid, spritePaths[0], new IntVector2(0, 0), new IntVector2(8, 9), false);
				...
				bool flag3 = BleakBulleet == null;
				if (flag3)
				{
					BleakBulleet = SpriteBuilder.ConstructCollection(prefab, "BleakBullet_Collection");
					UnityEngine.Object.DontDestroyOnLoad(BleakBulleet);
					for (int i = 0; i < spritePaths.Length; i++)
					{
						SpriteBuilder.AddSpriteToCollection(spritePaths[i], BleakBulleet);
					}
					SpriteBuilder.AddAnimation(companion.spriteAnimator, BleakBulleet, new List<int>
					{
				...
				bs.MovementBehaviors = new List<MovementBehaviorBase>
			{
				...
				Game.Enemies.Add("psog:bleak_bullet", companion.aiActor);
				PlanetsideModule.Strings.Enemies.Set("#BLEAK", "BleakBubbles");
				companion.aiActor.OverrideDisplayName = "#BLEAK";
				companion.aiActor.ActorName = "#BLEAK";
				companion.aiActor.name = "#BLEAK";
		...
		private static string[] spritePaths = new string[]
		{
			...
			"Planetside/Resources/Enemies/ModderBullets/bleak/bleakbullet_idle_001.png",
			"Planetside/Resources/Enemies/ModderBullets/bleak/bleakbullet_idle_002.png",
			"Planetside/Resources/Enemies/ModderBullets/bleak/bleakbullet_idle_003.png",
			"Planetside/Resources/Enemies/ModderBullets/bleak/bleakbullet_idle_004.png",


			//death
			"Planetside/Resources/Enemies/ModderBullets/bleak/bleakbullet_die_001.png",
			"Planetside/Resources/Enemies/ModderBullets/bleak/bleakbullet_die_002.png",
			"Planetside/Resources/Enemies/ModderBullets/bleak/bleakbullet_die_003.png",
			"Planetside/Resources/Enemies/ModderBullets/bleak/bleakbullet_die_004.png",
			"Planetside/Resources/Enemies/ModderBullets/bleak/bleakbullet_die_005.png",
