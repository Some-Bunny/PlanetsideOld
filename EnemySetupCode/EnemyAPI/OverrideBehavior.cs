...
{
    public abstract class OverrideBehaviorEnemy
    {
    ...
    public class EnemyAPICustomBulletScriptSelector : BulletScriptSelector
    {
        public Type bulletType;

        public EnemyAPICustomBulletScriptSelector(Type _bulletType)
        {
