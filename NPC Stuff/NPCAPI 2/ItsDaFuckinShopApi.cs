...
namespace NpcApi
{
    static class ItsDaFuckinShopApi
    {
        ...
        public static Vector3 defaultShopPosition = new Vector3(0.8125f, 2.1875f, -1.31f);
        public static Vector3 defaultShopKeeperPosition = new Vector3(1.9375f, 3.4375f, 5.9375f);
        ...
        public static GameObject SetUpShop(string name, string prefix, List<string> idleSpritePaths, int idleFps, List<string> talkSpritePaths, int talkFps, GenericLootTable lootTable, CustomShopItemController.ShopCurrencyType currency, string runBasedMultilineGenericStringKey,
            string runBasedMultilineStopperStringKey, string purchaseItemStringKey, string purchaseItemFailedStringKey, string introStringKey, string attackedStringKey, Vector3 talkPointOffset, Vector3 shopkeeperOffset,  Vector3[] itemPositions = null, float costModifier = 1, bool hasCarpet = false, string carpetSpritePath = "", bool giveStatsOnPurchase = false,
            ...
            Action<PlayerController, PickupObject, int> OnPurchase = null, Action<PlayerController, PickupObject, int> OnSteal = null, string currencyIconPath = "", string currencyName = "", bool canBeRobbed = true)
        {
            ...
            try
            {
                ...
                npcObj.transform.position = shopkeeperOffset;
