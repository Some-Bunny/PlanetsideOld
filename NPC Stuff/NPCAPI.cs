...
namespace Planetside
{
    class ItsDaFuckinShopApi
    {
        ...
        public static GameObject SetUpShop(string name, string prefix, List<string> idleSpritePaths, int idleFps, List<string> talkSpritePaths, int talkFps, GenericLootTable lootTable, BaseShopController.AdditionalShopType shopType, string runBasedMultilineGenericStringKey,
            string runBasedMultilineStopperStringKey, string purchaseItemStringKey, string purchaseItemFailedStringKey, string introStringKey, string attackedStringKey, bool hasCarpet = false, string carpetSpritePath = "", float PriceMultiplier = 1f, float ShopkeeperPositionX = 1.9375f, float ShopkeeperPositionY = 3.4375f)
        {
            try
            {
                ...
                ItemPoint1.transform.position = new Vector3(-0.4375f, 1.6875f, 1);
                ...
                ItemPoint2.transform.position = new Vector3(1.1875f, 2.375f, 1);
                ...
                ItemPoint3.transform.position = new Vector3(2.625f, 1.6875f, 1);
                FakePrefab.MarkAsFakePrefab(ItemPoint3);
                UnityEngine.Object.DontDestroyOnLoad(ItemPoint3);
                ItemPoint3.SetActive(true);
                
                var ItemPoint4 = new GameObject("ItemPoint4");
                ItemPoint4.transform.position = new Vector3(1.125f, 1, 1);
                FakePrefab.MarkAsFakePrefab(ItemPoint4);
                UnityEngine.Object.DontDestroyOnLoad(ItemPoint4);
                ItemPoint4.SetActive(true);
                ...
                shopObj.spawnPositions = new Transform[] { ItemPoint1.transform, ItemPoint2.transform, ItemPoint3.transform , ItemPoint4.transform};
                ...
                shopObj.ShopCostModifier = PriceMultiplier;
                shopObj.FlagToSetOnEncounter = GungeonFlags.NONE;

                npcObj.transform.parent = shopObj.gameObject.transform;
                npcObj.transform.position = new Vector3(ShopkeeperPositionX, ShopkeeperPositionY, 5.9375f);
                ...
                if (hasCarpet)
                {
                    ...
                    carpetObj.transform.position = new Vector3(-1.5f, 0, 1.7f);
